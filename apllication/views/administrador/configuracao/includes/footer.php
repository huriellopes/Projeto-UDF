    ...
    <script>
        $(document).ready(function(e){
            // Função para abrir modal de sucesso em Atualizar Dados
            ...
            // Função para abrir modal de sucesso em Atualizar Senha
            $('#button-salva').on('click',function(){
                $.ajax({
                    type: "POST",
        ...
        function checarSenha(){
            ...
            if(password == '' || '' == confirmPassword){
                ...
                document.getElementById("button-salva").disabled = true;
                ...
                document.getElementById("button-salva").disabled = false;
            }
        }
    </script>
