...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="row">
        <div class="col-md-9">
            <h2 class="page-header">Atualizar Dados</h2>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-9">
        <form action="<?=base_url('administradorController/AtualizarDados');?>" method="POST" id="form">
            <div class="row">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <form action="<?=base_url('administradorController/AtualizaSenha');?>" method="post" id="senha">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="button-salva" class="btn btn-primary" disabled>Salvar</button>
                </div>
            </div>
        </form>
  </div>
