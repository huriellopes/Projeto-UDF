<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?=base_url('gestorController/InsereProduto');?>" method="POST" id="form">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <div class="has-error" id="div_valor">
                            <input type="text" name="valor" class="form-control" required="" id="txtvalor"/>
                            <span class="help-block">Informe o valor unitário</span>
                        </div>
                    </div>
                    <div class="col-md-4 form-group">
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <a href="<?=base_url('gestorController/produtos');?>" onclick="return confirm('Deseja Voltar?');" class="btn btn-default">Voltar</a>
                    </div>
                </div>
            </form>
        </div>
