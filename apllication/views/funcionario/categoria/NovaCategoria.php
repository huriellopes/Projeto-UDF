<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?=base_url('funcionarioController/InsereCategoria');?>" method="POST">
                <div class="row">
                    <!-- Categoria -->
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <a href="<?=base_url('funcionarioController/categorias');?>" class="btn btn-default btn-group">Voltar</a>
                    </div>
                </div>
            </form>
        </div>
