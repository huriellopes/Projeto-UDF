<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="row">
        <form action="<?=base_url('funcionarioController/atualizaFornecedor');?>" method="POST">
            ...
            <div class="row">
                <div class="col-md-12 form-group">
                    ...
                    <a href="<?=base_url('funcionarioController/fornecedores');?>" class="btn btn-default">Voltar</a>
                </div>
            </div><!-- Fim da Row -->
