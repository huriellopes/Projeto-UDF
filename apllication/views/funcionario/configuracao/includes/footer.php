    ...
    <script>
        $(document).ready(function(e){
            $('#salva').on('click',function(e){
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('funcionarioController/AtualizaSenha/'. $this->session->userdata('idUsuario'));?>",
                    cache: false,
                    data: $('#form').serialize(),
                    dataType: 'json',
    ...
    <script>
        $(document).ready(function(e){
            $('#atualizar').on('click',function(e){
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('funcionarioController/AtualizarDados/'. $this->session->userdata('idUsuario'));?>",
                    cache: false,
                    data: $('#form').serialize(),
                    dataType: 'json',
                    success: function(response){
