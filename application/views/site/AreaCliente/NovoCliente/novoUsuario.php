...
<div class="row">
    <div class="col-md-10">
        <form action="<?=base_url('siteController/salvaCliente');?>" method="POST" id="form" autocomplete="off">
            <div class="row">
            ...
            <div class="row">
                ...
                <!-- CPF -->
                <div class="col-md-6 form-group" id="idcpf">
                    <label for="">CPF: </label>
                    <div class="has-error" id="div_cpf">
                        <input type="text" class="form-control" name="Cpf" id="txtcpf" data-mask="000.000.000-00" maxlength="18" autocomplete="off">
                ...
                <div class="col-md-6 form-group" id="idcnpj" style="display:none">
                    ...
                    <div class="has-error" id="div_cnpj">
                        <input type="text" class="form-control" name="Cnpj" id="txtcnpj" data-mask="00.000.000/0000-00" maxlength="20" autocomplete="off">
