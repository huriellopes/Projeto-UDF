...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="row">
        <div class="col-md-9">
        <form action="<?=base_url('funcionarioController/AtualizarDados');?>" method="POST" id="form">
            <div class="row">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <form action="<?=base_url('funcionarioController/AtualizaSenha');?>" method="post" id="form">
